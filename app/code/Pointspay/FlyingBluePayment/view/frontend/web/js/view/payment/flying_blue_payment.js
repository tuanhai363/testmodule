        ...
        rendererList.push(
            {
                ...
                component: 'Pointspay_FlyingBluePayment/js/view/payment/method-renderer/flying_blue_payment'
            }
        );
...
define(['jquery', 'domReady!'], function ($) {
        ...
        $(document).ready(function () {
            ...
            var existCondition = setInterval(function () {
                if ($('.payment-method').length) {
                    ...
                    $('body').on('click', 'a[id="fbc_checkout_btn"][wl="true"]', function () {
        ...
        function getFlyingBlueButton() {
            // $('a[id="fbc_checkout_btn"][wl="true"]').remove();
        }

        function checkFocus() {
            //PPC.app.asyncRequestPPC();
            if (typeof $('a[id="fbc_checkout_btn"][wl="true"]') !== "undefined" && $('a[id="fbc_checkout_btn"][wl="true"]').attr('onclick') !== false) {
                //prevent redirect to points pay
                $('a[id="fbc_checkout_btn"][wl="true"]').attr("onclick", "(function(){})()");
            }
        }
