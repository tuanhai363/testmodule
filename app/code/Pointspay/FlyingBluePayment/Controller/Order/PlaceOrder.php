...
namespace Pointspay\FlyingBluePayment\Controller\Order;
...
class PlaceOrder extends \Magento\Framework\App\Action\Action
{
    ...
    public function createTransaction($order)
    {
        ...
        return $this->runCurl($url, $headers, 'POST', $paramsJSON);
    }
    ...
    private function getAuthHeaders($bearer = false)
    {
        if ($bearer) {
            ...
            $headers = ["Content-type: application/x-www-form-urlencoded", "Authorization: Basic " . $this->helper->getEncodedAuth()];
        }
        return $headers;
    }
