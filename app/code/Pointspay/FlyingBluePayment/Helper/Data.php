...
namespace Pointspay\FlyingBluePayment\Helper;

use Magento\Framework\Exception\NoSuchEntityException;
use Pointspay\FlyingBluePayment\Logger\Logger;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        $asset = $this->_assetRepo->createAsset('Pointspay_FlyingBluePayment::img');
        return $asset->getUrl();
    }
    ...
    public function getAuthChecksum($params)
    {
        ...
        return $md5_value && $this->getAPIAccessToken() ? hash_hmac('md5', $md5_value, $this->getAPIAccessToken()) : '';
    }
}
